...
from .thermal import (
    ...
    SHEPPARD_1999_INTERFACE_TEMPERATURE_EQ_2_25,
    SHEPPARD_1999_TOOL_STEEL_THERMAL_PROPERTIES,
    SHEPPARD_1999_TOOL_STEEL_THERMAL_PROPERTIES_SOURCE,
